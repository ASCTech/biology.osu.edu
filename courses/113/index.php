...
<p>Biology 113 is currently in a gradual state of development that will ultimately fulfill several
   goals of the Center for Life Sciences Education (CLSE). Current lab exercises that are more
   traditional in format are scheduled for replacement by inquiry method lab work where students form
   their own hypotheses, test them for validity through experimentation of their own design and
   interpret the results as a basis for a conclusion. Related to this lab method is CLSE's plan to
   implement a learning cycle approach in the lecture hall. Students first encounter biological
   topics and concepts in the laboratory by the exploratory manner described above, which the
   professor later expands and develops in lecture period &mdash; the inverse sequence of events
   usually seen in traditional teaching. And although no sooner than sometime in 2007, the complete
   renovation of Jennings Hall will give Biology 113 pristine, new laboratory rooms that are
   definitely worth the wait!</p>

<?
instructors(array('Summer 2007' => array('cogan.1', 'breitenberger.1'),
				  'Autumn 2007' => array('chang.108', 'weinstein.41'),
            )     );
