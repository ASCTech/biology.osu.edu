...
top('Honors Biology 115','NY Times');
menu('115');
?>
<h1>Honors Biology 115: New York Times Clippings Project</h1>
...
<ol>
 <li><p class="undent">Select a topic for your project:</p>
     <p>To start this project, you will pick an issue of interest to you from among many you will
        ...
        topic must be relevant to material being covered in Biology H115.</p>
...
<ol style="list-style-type: upper-alpha">
 ...
 <li>Opinion review
  <ul>
   ...
   <li>Brief introduction with clear statement of issue being reviewed</li>
   <li>Use other resources to include additional perspectives, as needed</li>
   <li>Complete citations as footnotes included</li>
   <li>The date of publication (or broadcast), page (or name of television or radio program), and
       column(s) in the case of newspapers and magazines indicated</li>
  </ul>
 </li>
</ol>
